	...
	<view class="page">
		<view class="header">
			...
			<view class="right">
				...
				<view class="date">日期：{{courseInfo.course_manage.start_date}}（周一）</view>
				<view class="date">时间：{{courseInfo.course_manage.start_time}} ~ {{courseInfo.course_manage.end_time}}</view>
				<view class="date">场馆：{{courseInfo.venue_name}}</view>
				<view class="date">场地：{{courseInfo.venue_name}}</view>
				<view class="date">成团人数：5人</view>
				<view class="date">老师：{{courseInfo.nickname}}</view>
			</view>
		</view>
