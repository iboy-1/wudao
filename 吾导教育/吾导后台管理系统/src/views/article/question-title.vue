<template>
    <div class="allOrder">
        <div class="buttonbox" @click="tianjia" v-if="judata.gglx_add">
            <div class="refresh">
                <img src="@/assets/添加.png" alt="">
            </div>
            <p>添加公告类型</p> 
        </div>  
        <div class="list"  v-if="judata.gglx_table">
            <div class="listname">
                <div class="number">标题名称</div>
            ...
            <div class="orders-box">
                <div class="listdata" v-for="(item,index) in list">
                    ...
                    <div class="operation caozuo">
                        <el-button size="mini" @click="change(item.id,item)" v-if="judata.gglx_edit">编辑</el-button>
                        <!-- <el-button size="mini" @click="Delete(item.id)" v-if="judata.gglx_del">删除</el-button> -->
                    </div>                      
                </div>
            </div>
        </div> 
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            change(id,item){
                this.id = id
                this.name = item.poblem_group_title
                // this.sort = item.sort
                this.title = '编辑常见问题分组'
                this.firstbox = true
            },
