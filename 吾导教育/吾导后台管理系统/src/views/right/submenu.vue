	...
	<div class="juisdiction">
		...
		<div class="order-Text">
		    <ul>
		        ...
		        <li class="time">菜单描述</li>
				<li class="time">菜单路由</li>
		...
		<div class="lounge-Information">
		    <div class="Information" v-for="(item,index) of list" :key="index">
		        ...
		        <div class="operation">
					<div class="" @click="seeUser(item)">查看按钮</div>
		            <div @click="changePower(item,index)">编辑</div>
		            <div class="del" @click="delsubmenu(item)">删除</div>
		        </div>
		    </div>
		</div>
		<!-- 分页 -->
		...
		<div class="pop" v-if="showModal">
			...
			<div class="center">
				...
				<div class="textarea">
					<p>填写描述：</p>
					<textarea class="bottominput" name="" id="" cols="30" rows="10" v-model="remarks" placeholder="请输入子菜单描述"></textarea>
				</div>
			</div>
			<div class="footer">
				<div class="btn">
		...
		<div class="pop" v-if="editshowModal">
			...
			<div class="center">
				...
				<div class="textarea">
					<p>编辑描述：</p>
					<textarea class="bottominput" name="" id="" cols="30" rows="10" v-model="remarks1" placeholder="请输入子菜单描述"></textarea>
				</div>
			</div>
			<div class="footer">
				<div class="btn">
...
export default {
	...
	methods:{
		...
		render(){
            ...
            // $.ajax({
            //     url:"http://192.168.3.4/ldy/public/index.php/ljairport/v1/YfnPower/getElement",
            //     data:{
			// 		menu_id:this.id,
            //         page:this.page,
            //         listrows:this.limit
		...
		addCommit(){
			...
			// $.ajax({
            //     url:"http://192.168.3.4/ldy/public/index.php/ljairport/v1/YfnPower/addElement",
            //     data:{
			// 		menu_id:this.id,
			// 		name:this.name,
			// 		path:this.path,
		...
		updateCommit(){
			...
			// $.ajax({
            //     url:"http://192.168.3.4/ldy/public/index.php/ljairport/v1/YfnPower/editElement",
            //     data:{
			// 		id:this.info.id,
			// 		name:this.name1,
			// 		path:this.path1,
		...
		deldateCommit(){
            ...
            // $.ajax({
            //     url:"http://192.168.3.4/ldy/public/index.php/ljairport/v1/YfnPower/delElement",
            //     data:{
			// 		id:this.info.id,
			// 		creator:this.creator.data[0].name,
            //     },
