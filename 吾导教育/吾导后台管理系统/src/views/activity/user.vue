<template>
    <div class="whole">
        <!-- 搜索框 -->
        <div class="search" v-if="judata.cyhdyh_ss">
            <el-input placeholder="输入用户姓名" v-model="search.nikanme"></el-input>
            <el-input placeholder="输入活动标题" v-model="search.activity_title"></el-input>
        ...
        <!-- 表头 -->
        <div class="order-Text" v-if="judata.cyhdyh_table">
            <ul>
                <li class="adminId">活动标题</li>
                ...
                <li class="income">活动开始时间</li>
                <li class="income">活动结束时间</li>
                <li class="income">参与活动时间</li>
                <li class="head_portrait">活动状态</li>
                <li class="operation">操作</li>
            </ul>
        </div>
        <!-- 列表 -->
        <div class="list-Information" v-if="judata.cyhdyh_table">
                ...
                <ul>
                    ...
                    <li class="operation">
                        <div class="operation-btn">
                            <el-button size="mini " @click="userDetail(item)" v-if="judata.cyhdyh_see">查看</el-button>
                            <!-- <el-button size="mini " @click="userDetail1(item)" >购买记录</el-button>
                            <el-button size="mini " @click="userDetail2(item)" >转卡</el-button> -->
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="pop" v-if="see">
               ...
               <div class="see_center">
                    <div class="_left">
                        <ul>
                            <li>
                                <div class="_text_1">活动图片:</div>
                                <div class="_head_portrait">
                                    <img :src="userInfo.activity_image" alt="">
                                </div>
                            </li>
                            <li>
                                <div class="_left_box">
                                ...
                                <div class="_right_box">
                                    <div class="_text">活动开始时间：</div>
                                    <div class="_text1">{{userInfo.start_time}}</div>
                                </div>
                            </li>
                            <li>
                                <div class="_left_box">
                                    <div class="_text">用户ID：</div>
                                    <div class="_text1">{{userInfo.user_id}}</div>
                                </div>
                                <div class="_right_box">
                                    <div class="_text">活动结束时间：</div>
                                    <div class="_text1">{{userInfo.end_time}}</div>
                                </div>
                            </li>
                            <li>
                                <div class="_left_box">
                                ...
                                <div class="_right_box">
                                    <div class="_text">参与活动时间：</div>
                                    <div class="_text1">{{userInfo.add_date}}</div>
                                </div>
                            </li>
                            <li>
                                <div class="_left_box">
                                    <div class="_text">活动简介：</div>
                                    <div class="_text1" v-if="userInfo.activity_introduction == -1">无</div>
                                    <div class="_text1" v-else>{{userInfo.activity_introduction}}</div>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <!-- 分页 -->
        <div class="Paging" v-if="searchRender && judata.cyhdyh_table">
        ...
        methods:{
            ...
            handleCurrentChange(val){
                ...
                if(this.searchData){
                    ...
                    api.queryActivityUser(obj).then(res=>{
