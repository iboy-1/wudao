<template>
    <div class="whole">
        <!-- 按钮 -->
        <div class="btn" v-if="judata.qmkj_add">
        ...
        <div class="add_pop" v-if="addMemu">
            ...
            <div class="add_content">
                <div class="input1">
                    <div class="text"><span>活动图片</span></div>
                    <div class="">
                ...
                <div class="input1">
                    ...
                    <div class=""><el-input v-model="form.title" placeholder="输入内容标题"></el-input></div>
                </div>
                <div class="input1">
                    <div class="text"><span>优惠类型</span></div>
                    <div class="">
                        <el-radio v-model="form.preference_type" label="1">固定值</el-radio>
                        <el-radio v-model="form.preference_type" label="2">百分比</el-radio>
                    </div>
                </div>
                <div class="input1">
                    <div class="text"><span>提成</span></div>
                    <div class="input1">
                        <el-input v-model="form.preference" placeholder="列：20" v-if="form.preference_type == 1">
                            <template slot="append">元</template>
                        </el-input>
                        <el-input v-model="form.preference" placeholder="列：20" v-if="form.preference_type == 2">
                            <template slot="append">%</template>
                        </el-input>
                    </div>
                </div>
                <div class="input1">
                    <div class="text"><span>邀请人数</span></div>
                    <div class="input1">
                ...
                <div class="input2">
                    <div class="text"><span>选择会员卡</span></div>
                    <div class="">
                        <el-select v-model="form.member_card_id" placeholder="选择会员卡">
                            <el-option
                ...
                <div class="input1">
                    ...
                    <div class="textarea">
                        <textarea class="bottominput" name="" id="" cols="30" rows="10" v-model="form.introduction" placeholder="请输入活动简介"></textarea>
                    </div>
                </div>
                <div class="input3">
        ...
        <!-- 列表 --> 
        <div class="form_information" v-if="judata.qmkj_table">
            <ul>
                <li v-for="(item,index) in list" :key="index">
                    ...
                    <div class="answer">
                        <p class="_descBox" v-html="item.content"></p>
                    </div>
                    <div class="problem1">
                    ...
                    <div class="operation">
                        <el-button @click="changeProblem(item)" v-if="judata.qmkj_edit">编辑</el-button>
                        <el-button @click="Delete(item.id)" v-if="judata.qmkj_del">删除</el-button>
        ...
        <!-- 分页 -->
        <div class="Paging" v-if="judata.qmkj_table">
        ...
        methods:{
            ...
            render(){
                ...
                api2.query({
                    ...
                    // console.log(res.data.data);
                    _this.options1 = res.data.data.data
                }).catch(res=>{
                    this.$message({
                        message: '网络错误请稍后再试',
                        type:'error'
            ...
            changeProblem(arr){
                ...
                this.form =  {
                    ...
                    member_card_id:Number(arr.member_card_id),
                    title:arr.title,
                    introduction:arr.introduction,    //简介
                    image:arr.image,
                    content:arr.content,
                    preference_type:arr.preference_type,
                    preference:arr.preference,
                    number:arr.number,
                    status:arr.status,
                }
                if (arr.status  == 2) {
                ...
                if (arr.image != '' && arr.image!= '-1') {
                    this.hotel1ImageUrl = arr.image
            ...
            commit(){
                ...
                if(this.form.title == ''){
                    ...
                    return false
                }  else if (this.form.member_card_id == '') {
                    this.$message({
                        message: '请选择会员卡'
                    });
                    return false
                }   else if (this.form.preference == '') {
                    this.$message({
                        message: '请选择提成'
                    });
                    return false
                ...
                if(this.memuTitle == '添加活动'){ 
                    api.addActivityHaggle(this.form).then(res=>{
                        if(res.data.code == 200){
                            this.$message({
                                message: '添加成功',
                                type:'success'
                    ...
                    api.updateActivityHaggle(this.form).then(res=>{
                        if(res.data.code == 200){
                            this.$message({
                                message: '编辑成功',
                                type:'success'
