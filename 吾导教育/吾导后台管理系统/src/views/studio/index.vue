<template>
    <div class="whole">
        <div class="search" v-if="judata.gzsgl_search">
            <el-input v-model="search.venue_name" placeholder="请输入场馆名"></el-input>
        ...
        <div class="btn">
            ...
            <div class="refresh" @click="Refresh" v-if="judata.gzsgl_sx"><img src="@/assets/刷新@2x.png" alt="">刷新</div>
            <div class="refresh" @click="add_teacher" v-if="judata.gzsgl_add"><img src="@/assets/添加@2x.png" alt="">添加</div>
        </div>
        <!-- 表格 -->
        <div class="form_head" v-if="judata.gzsgl_table">
            <ul>
                <li class="adminid">ID</li>
                <li class="name">场馆图片</li>
                <li class="name">场馆</li>
                <li class="name">地址</li>
                <li class="operation">操作</li>
            </ul>
        </div>
        <div class="form_information" v-if="judata.gzsgl_table">
            <ul>
                <li v-for="(item,index) in list" :key="index">
                    ...
                    <div class="name">
                        <span v-if="item.venue_name == -1">未填写</span>
                        <span v-else>{{item.venue_name}}</span>
                    </div>
                    <div class="name">
                        <span v-if="item.address == -1">无</span>
                        <span v-else>{{item.address}}</span>
                    </div>
                    <div class="operation">
                        <!-- <div class="see" @click="see_btn(item)">查看</div> -->
                        <el-button size="medium" @click="add_btn(item)" v-if="judata.gzsgl_kcgl">课程管理</el-button>
                        <el-button size="medium" @click="contact1(item)" v-if="judata.gzsgl_edit">修改</el-button>
                        <el-button type="danger" size="medium" @click="delete_btn(item)" v-if="judata.gzsgl_del">删除</el-button>
                        <!-- <div class="see" @click="add_btn(item)">课程管理</div>
        ...
        <!-- 分页 -->
        <div class="Paging" v-if="searchRender && judata.gzsgl_table">
        ...
        <div class="pop" v-if="add_isShow">
                ...
                <div class="box">
                    <el-form ref="form" :model="form" label-width="80px">
                        ...
                        <el-form-item label="场馆名称">
                            <el-input v-model="form.venue_name" placeholder="请输入场馆名称"></el-input>
                        </el-form-item>
                        <el-form-item label="场馆地址">
                            <el-input v-model="form.address" placeholder="请输入场馆地址"></el-input>
                        </el-form-item>
                        <el-form-item label="场馆坐标">
                            <el-input v-model="form.coordinate" placeholder="请输入场馆坐标"></el-input>
                             <el-link icon="el-icon-edit" href="https://lbs.amap.com/tools/picker" :underline="false" target="_blank" type="danger">获取经纬度</el-link>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
            <div class="btnMessage">
                ...
                <div class="determine" type="primary" @click="commitArticle(1)" v-if="dialogTitle == '添加工作室'">确 定</div>
                <div class="determine" type="primary" @click="commitArticle(2)" v-else-if="dialogTitle == '修改工作室'">确 定</div>
            </div>
        </div>
        ...
        <div class="pop" v-if="del_isShow">
            ...
            <div class="content1">
                <span>
                    温馨提示：删除该工作室会影响与该工作室有关的教师和会员卡信息
                </span>
            </div>
            <div class="btnMessage">
...
export default {
    ...
    data(){
        return{
            ...
            del_isShow:false,
            del_id:'',
            dialogTitle1:'是否删除该工作室',
            dialogTitle2:"查看工作室信息",
            hotel1FileList:[],
            hotel1ImageUrl:'',
    ...
    methods:{
        ...
        contact1(arr){
            this.dialogTitle = "修改工作室"
            this.hotel1FileList = []
            this.form = {
                id:arr.id,
                venue_name: arr.venue_name,
                address: arr.address,
                image_url:arr.image_url,
                coordinate:arr.coordinate, 
            }
            if (arr.image_url != '' && arr.image_url!= '-1') {
                this.hotel1ImageUrl = arr.image_url
